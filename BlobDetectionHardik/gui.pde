...
public void playMainGameClick(GImageButton source, GEvent event){
  if(untouchable)return;
      commonDelay();
  uiengine.turnBtn(new int[]{40,41,42,28},false);
...
public void playCompeteModeClick(GImageButton source, GEvent event){
  if(untouchable)return;
        commonDelay();
    uiengine.switchOn(new int[]{6});
  ...
  */
  ...
  UIElement[] L =new UIElement[] {new UIButton(new int[]{0,1},1,this,new String[]{"ui_elements/play_game_btn.png"},0.45,0.3,0.4,0.192,"playMainGameClick"),
    ...
    //  new UIButton(new int[]{1},6,this,new String[]{"ui_elements/home_button.png"},0.87,0.83,0.001,0.01,"backButtonClick"),
      ...
      new UIButton(new int[]{0,1},40,this,new String[]{"ui_elements/new/play_button.png"},0.65,0.1,0.25,0.4,"playMainGameClick"),
      new UIButton(new int[]{0,1},41,this,new String[]{"ui_elements/new/test.png"},0.4,0.3,0.25,0.4,"testMyTowerClick"),
      new UIButton(new int[]{0,1},42,this,new String[]{"ui_elements/new/compete.png"},0.65,0.55,0.25,0.4,"playCompeteModeClick"),
